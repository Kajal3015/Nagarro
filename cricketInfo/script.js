...
function getFactFetch() {
    ...
    fetch(url)
        ...
        .then((data) => {
            ...
            root.innerHTML = `<h1 class="display-4 w-100 text-center mb-3"><span class="text-danger"><p>Live Cricket Score</p></span></h1>`;
            for (let i = 0; i < 4; i++) {
                count++;
            ...
            <div class="card my-2 border-0 overflow-hidden">
                ...
                <div class="score card-body w-100 bg-dark text-white px-5">
                    ...
                    <p class="innings">${typeof match.score[0] === "undefined"
                        ? ""
                        : match.score[0].inning
                    }</p>
                      <p class="score">${typeof match.score[0] === "undefined"
                        ? ""
                        : match.score[0].r +
                        "/" +
                        match.score[0].w +
                    ...
                    <div class="team-inning">
                        <p class="innings">${typeof match.score[1] === "undefined"
                        ? ""
                        : match.score[1].inning
                    }</p>
                        <p class="score">${typeof match.score[1] === "undefined"
                        ? ""
                        : match.score[1].r +
                        "/" +
                        match.score[1].w +
